...
map.getView().fit([-13345601.758071, 1279174.551658, -9406001.996535, 4318376.230928], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Actualización de Cobertura de Imágenes Satelitales OneAtlas 2026</h2>';
        return titleElement;
    })(),
